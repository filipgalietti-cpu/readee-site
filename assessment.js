...
function nextQuestion(type) {
  ...
  const currentSlide = form.querySelector(
    `.question-slide[data-question="${currentQuestionIndex[type]}"]`
  );
  ...
  const nextSlide = form.querySelector(
    `.question-slide[data-question="${currentQuestionIndex[type]}"]`
  );
...
function prevQuestion(type) {
  ...
  currentQuestionIndex[type]--;
  const prevSlide = form.querySelector(
    `.question-slide[data-question="${currentQuestionIndex[type]}"]`
  );
