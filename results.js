...
function showRecommendationMessage(plan, userType) {
  ...
  const reasons = {
    lite: {
      adult:
        "Perfect for families or small groups who want essential reading support with a budget-friendly approach. Get started with proven methods at an accessible price.",
      child:
        "A great way to start your reading journey! This plan has everything you need to practice and improve at your own pace.",
    },
    recommended: {
      adult:
        "Strikes the perfect balance between capability and affordability. Comprehensive tracking, adaptive lessons, and dedicated support give you everything needed to achieve real results.",
      child:
        "This is our most popular plan! You'll get fun lessons, cool rewards, and tools to help you become an awesome reader!",
    },
    premium: {
      adult:
        "The complete solution for maximum impact. With unlimited accounts, AI-powered personalization, and dedicated coaching, this plan is designed for schools and educators who need advanced tools and support.",
      child:
        "The ultimate reading experience! Get special help tailored just for you, plus all the advanced features to help you become the best reader you can be.",
    },
  };
...
function selectPlan(plan) {
  ...
  if (plan === "premium") {
    ...
    alert(
      "Thank you for your interest in READEE Premium! Our sales team will contact you shortly to discuss your needs and provide a custom quote."
    );
